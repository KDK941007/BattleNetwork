(()=>{
  ...
  let patternIndex=1;
  // Temporary device-test patterns: selected telegraph 850ms and shockwave speed 520 are fixed; vary only Full Sync window.
  const patterns=Object.freeze([
    Object.freeze({id:'A',label:'A',moveSpeedWorld:95,telegraphMs:850,fullSyncWindowMs:140,recoveryMs:350,cooldownMs:1250,projectileSpeed:520,maxRangeTiles:5}),
    ...
    Object.freeze({id:'C',label:'C',moveSpeedWorld:95,telegraphMs:850,fullSyncWindowMs:220,recoveryMs:350,cooldownMs:1250,projectileSpeed:520,maxRangeTiles:5})
  ]);
