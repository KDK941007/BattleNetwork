(()=>{
  ...
  const closedStyle='position:absolute;right:10px;top:10px;z-index:70;display:flex;align-items:flex-start;gap:4px;padding:4px 5px;border:1px solid rgba(255,255,255,.5);border-radius:7px;background:rgba(8,12,20,.88);color:#fff;font:700 10px/1.15 system-ui,sans-serif;pointer-events:auto;max-width:calc(100% - 20px);box-sizing:border-box;';
